...
def generate_launch_description():
    ...
    args = [
        ...
        DeclareLaunchArgument('ir_info_url', default_value='/home/nack/vision_ws/src/orbbec_camera/config/ir_intrinsics.yaml'),
        DeclareLaunchArgument('color_info_url', default_value='/home/nack/vision_ws/src/orbbec_camera/config/color_intrinsics.yaml'),
